...
public class ShapeDraw extends JPanel {
    ...
    public ShapeDraw() {  
        ...
        sizeButton = new JComboBox<String>();  // color choice menu
        sizeButton.addItem("1");
        sizeButton.addItem("2");
        sizeButton.addItem("3");
        sizeButton.addItem("4");
        sizeButton.addItem("5");
       
        sizeButton.addActionListener(canvas);                        
    ...
    class DrawingArea extends JPanel
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            if (evt.getSource() == sizeButton) {
                switch ( sizeButton.getSelectedIndex() ) {
                case 0: {cwidth*=1; cheight*=1;}    break;
                case 1: {cwidth*=2; cheight*=2;}   break;
                case 2: {cwidth*=3; cheight*=3;}    break;
                case 3: {cwidth*=4; cheight*=4;}    break;
                case 4: {cwidth*=5; cheight*=5;}    break;
        ...
        void addShape(Shape shape) {
            ...
            shape.reshape(3,3,cwidth,cheight);
